import z from "zod";
import { cargoFuncionario } from "../../types/cargoEnum";

export const createFuncionarioDTO = z
  .object({
    email: z
      .string({
    ...
    senha: z
      ...
      .min(1),
    cargo: z.enum(["Colaborador", "Técnico", "Administrador"], {
      required_error: "Insira um cargo.",
